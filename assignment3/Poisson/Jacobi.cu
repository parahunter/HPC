...
{ 
		...
		printf("%f \t %f \t %f \t", time_gold, time_v1, time_v2);
		printf(" %f \t %f \t", transfer_v1/(time_v1+transfer_v1), transfer_v2/(time_v2+transfer_v2));
		printf(" %f \t %f \n", transfer_v1, transfer_v2);
		return;
...
printf("%3.2f \t %.2f \t",time_gold,time_blas/time_gold); //cpu time 2 and speedup
    ...
    printf("%3.2f \t %.2f \t",time_v1,time_blas/time_v2); //gpu 2 time 1
